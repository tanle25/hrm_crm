...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        vision_provider=os.getenv("VISION_PROVIDER", "router").strip().lower(),
        openrouter_api_key=os.getenv("OPENROUTER_API_KEY"),
        openrouter_base=os.getenv("OPENROUTER_BASE", "https://openrouter.ai/api/v1"),
        vision_model=os.getenv("VISION_MODEL") or os.getenv("LLM_MODEL_WRITER", "cx/gpt-5.2"),
        ...
        flowkit_base_url=os.getenv("FLOWKIT_BASE_URL") or os.getenv("FLOWKIT_URL") or "https://flow.tanflux.tech",
        flowkit_api_key=os.getenv("FLOWKIT_API_KEY") or os.getenv("FK_API_KEY") or "tanflux-flowkit-2026",
